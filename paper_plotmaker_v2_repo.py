...
def plot_experiments(data, models_to_plot, metric='accuracy', add_title=False, output_file=None):
    """
...
def main():
    parser = argparse.ArgumentParser(description='Plot experiment metrics across iterations')
    parser.add_argument('--file', '-f', type=str, required=True, help='Path to the JSON data file')
    parser.add_argument('--models', '-m', type=str, nargs='+', help='Models to plot')
    parser.add_argument('--metric', type=str, default='accuracy', help='Metric to plot (default: accuracy)')
    parser.add_argument('--title', action='store_true', help='Add title to the plot')
    parser.add_argument('--output', '-o', type=str, help='Output file path to save the plot')
    parser.add_argument('--list-models', action='store_true', help='List all available models in the data file')
    parser.add_argument('--list-metrics', action='store_true', help='List all available metrics in the data file')
    ...
    if not args.models:
        print("Error: No models specified. Use --models to specify which models to plot.")
        list_available_models(data)
        return
